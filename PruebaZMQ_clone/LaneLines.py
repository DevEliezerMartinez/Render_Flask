...
class LaneLines:
    ...
    def __init__(self):
        ...
        self.dir = []
        self.left_curve_img = mpimg.imread('izquierda.png')
        self.right_curve_img = mpimg.imread('derecha.png')
        self.keep_straight_img = mpimg.imread('UP.png')
    ...
    def fit_poly(self, img):
        ...
        for i, y in enumerate(ploty):
            ...
            r = int(right_fitx[i])
            y = int(y)
            cv2.line(out_img, (l, y), (r, y), (252, 219, 3))
    ...
    def plot(self, out_img):
        ...
        msg = "Sigue adelante!"
        curvature_msg = "Curvatura = {:.0f} m".format(min(lR, rR))
        if direction == 'L':
        ...
        cv2.putText(out_img, msg, org=(10, 240), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=0.8, color=(255, 255, 255), thickness=1)
        if direction in 'LR':
            cv2.putText(out_img, curvature_msg, org=(10, 280), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=0.8, color=(255, 255, 255), thickness=1)
            
        #Debug para el centro de un vehiculo y lo alejado que esta de el     
        """
        cv2.putText(
            out_img,
        ...
        cv2.putText(
            out_img,
            "El vehiculo esta  {:.2f} m lejos del centro".format(pos),
            org=(10, 450),
            fontFace=cv2.FONT_HERSHEY_SIMPLEX,
            fontScale=0.66,
            color=(255, 255, 255),
...
"""
TODO:
Cambiar de lugar las flechas 
Medir la transmision de los datos
Carrito: Enviar JS to Python 
"""